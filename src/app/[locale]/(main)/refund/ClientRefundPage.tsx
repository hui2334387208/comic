...
export default function ClientRefundPage() {
  const t = useTranslations('main.refund')
    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50 dark:from-gray-900 dark:via-red-900/20 dark:to-orange-900/20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400 mb-6">
          ...
          <span>/</span>
          <span className="text-red-800 dark:text-red-300 font-medium">{t('breadcrumb.refund')}</span>
        </nav>
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-red-600 to-orange-600 rounded-full mb-6 shadow-lg">
            <span className="text-2xl font-bold text-white">退</span>
          </div>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border-2 border-red-200 dark:border-red-800 relative overflow-hidden">
            ...
            <h2 className="text-2xl font-bold bg-gradient-to-r from-red-600 to-orange-600 bg-clip-text text-transparent mb-4">{t('sections.conditions.title')}</h2>
            <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
              {t.raw('sections.conditions.items').map((item: string, index: number) => (
                <li key={index} className="hover:text-red-600 dark:hover:text-red-400 transition-colors" dangerouslySetInnerHTML={{ __html: item }} />
              ))}
            </ul>
          </div>
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border-2 border-orange-200 dark:border-orange-800 relative overflow-hidden">
            ...
            <h2 className="text-2xl font-bold bg-gradient-to-r from-orange-600 to-yellow-600 bg-clip-text text-transparent mb-4">{t('sections.process.title')}</h2>
            <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
              {t.raw('sections.process.items').map((item: string, index: number) => (
          ...
          <div className="bg-gradient-to-r from-red-600/10 via-orange-600/10 to-yellow-600/10 rounded-2xl p-8 border-2 border-red-300 dark:border-red-700 shadow-xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-2 text-gray-600 dark:text-gray-400">
                <p dangerouslySetInnerHTML={{ __html: t('sections.contact.email') }} />
              </div>
              <div className="mt-6">
                <Link
                  href="/contact"
